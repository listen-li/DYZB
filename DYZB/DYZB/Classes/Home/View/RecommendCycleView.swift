...
extension RecommendCycleView {
    class func recommendCyleView() -> RecommendCycleView {
...
extension  RecommendCycleView {
    func addCycleTimer() {
        cycleTimer = Timer(timeInterval: 3.0, target: self, selector: #selector(self.scorllToNext), userInfo: nil, repeats: true)
    ...
    @objc private func scorllToNext() {
        //1.获取滚动的偏移量
